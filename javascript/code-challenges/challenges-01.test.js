...
const addOne = (arr) => {
  let myArr = [];
  arr.forEach (element =>myArr.push(element + 1));
  return myArr;
...
const addExclamation = (arr) => {
  let myExArr = [];
  arr.forEach (element => myExArr.push (element + '!'));
  return myExArr;
  // Solution code here...
};
...
const allUpperCase = (arr) => {
  let arrUpper = [];
  arr.forEach (element => arrUpper.push(element.toUpperCase()));
  return arrUpper;
  // Solution code here...
};
...
const speaker = (words, callback) => {
  let talk = [];
  words.forEach (value => talk.push(callback(value)));
  return talk;
  // Solution code here...
...
const createList = (availableItems) => {
  let newItems =[];
  availableItems.forEach(item => newItems.push(item));
  return newItems;
  // Solution code here...
};
