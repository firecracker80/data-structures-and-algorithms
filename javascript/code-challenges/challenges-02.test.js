...
const raisedToTheThird = (arr) => {
  let arrEx = arr.map (value => Math.pow(value,3));
  return arrEx;
...
const addOne = (arr) => {
  let plusOne = arr.map(value => value + 1);
  return plusOne;
  // Solution code here...
};
...
const forLoopTwoToThe = (arr) => {
  let twoToThe = arr.map(value => Math.pow(2,value));
  return twoToThe;
  // Solution code here...
};
...
const forEachTwoToThe = (arr) => {
  let eachTwoToThe = [];
  arr.forEach(value => eachTwoToThe.push(Math.pow(2,value)));
  return eachTwoToThe;
  // Solution code here...
};
...
const mapTwoToThe = (arr) => {
  let newMap = arr.map(value => Math.pow(2, value));
  return newMap;
  // Solution code here...
};
