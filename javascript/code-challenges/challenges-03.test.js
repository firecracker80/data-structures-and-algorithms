...
const addTwo = (arr) => {
  let newTwo = [];
  arr.forEach(value => newTwo.push(value + 2));
  return newTwo;
  // Solution code here...
};
...
const typeNum = (arr) => {
  let numOnly = arr.filter(element => typeof element === 'number');
  return numOnly;
  // Solution code here...
};
...
const oddValues = (arr) => {
  ...
  return oddArr;
  // return oddArr.push(element % 2 !== 0);
  // Solution code here...
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  let notFirst = arr.filter(element => !forbiddenValues.includes(element));
  return notFirst;
  // Solution code here...
};
